(function () {
...
})()(
  {
      ...
      function (require, module, exports) {
        function lexClojure(text) {
          ...
          while (
            ...
            lexer.tokens[lexer.tokens.length - 1].type === "eol"
          ) {
            lexer.tokens.pop();
          }
    ...
    4: [
      function (require, module, exports) {
        ...
        function createDrakonTechGenerator(options) {
          ...
          function computeAllowed(context, itemId, computeArg) {
            ...
            reportError(
              "Can compute only own algoprops",
              context.fun.path,
              itemId,
            );
            return false;
      ...
      { "./astScanner": 1, "./clojurelexer": 3, "./sort": 5, "./tools": 6 },
    ],
    5: [
      function (require, module, exports) {
